% function v = ftcs(u_inicial, x_inicial, x_final, t_final, lambda, h)
%
% v = ftcs(u_inicial, x_inicial, x_final, t_final, lambda, h)
%
% ESQUEMA FORWARD-TIME CENTRAL-SPACE: resolve um PVC 
...
function v = ftcs(u_inicial, x_inicial, x_final, t_final, a, lambda, h)
