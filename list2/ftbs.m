% function v = ftbs(u_inicial, x_inicial, x_final, t_final, lambda, h)
%
% v = ftbs(u_inicial, x_inicial, x_final, t_final, lambda, h)
%
% ESQUEMA FORWARD-TIME BACKWARD-SPACE: resolve um PVC 
...
function v = ftbs(u_inicial, x_inicial, x_final, t_final, a, lambda, h)
